...
VALUES
('Basic Plan', 100, 500, 100, 1, 'Affordable for light users'),
('Standard Plan', 200, 1000, 300, 5, 'Best for regular users'),
('Premium Plan', 500, 5000, 1000, 50, 'Ideal for heavy users'),
('Unlimited Plan', 800, 10000, 5000, 100, 'Unlimited data and calls'),
('Family Plan', 300, 3000, 500, 20, 'Shared for family'),
('Student Plan', 150, 1500, 200, 10, 'Affordable for students'),
('Business Plan', 600, 2000, 2000, 50, 'Designed for businesses');

INSERT INTO Subscription (mobileNo, planID, subscription_date, status)
VALUES
('01234567890', 102, '2023-06-01', 'active');

INSERT INTO Subscription (mobileNo, planID, subscription_date, status)
VALUES
('01122334455', 103, '2024-12-01', 'active');



INSERT INTO Subscription (mobileNo, planID, subscription_date, status)
VALUES
('09876543210', 102, '2024-12-01', 'active');

SET IDENTITY_INSERT Plan_Usage ON;
INSERT INTO Plan_Usage (usageID, start_date, end_date, data_consumption, minutes_used, SMS_sent, mobileNo, planID)
VALUES (10, '2024-12-1', '2024-12-31', 3500, 800, 150, '09876543210', 102)
SET IDENTITY_INSERT Plan_Usage OFF;

SET IDENTITY_INSERT Payment ON;
INSERT INTO Payment (paymentID, amount, date_of_payment, payment_method, status, mobileNo)
VALUES (8, 10.0, '2023-01-01', 'credit', 'successful', '01234567890')
SET IDENTITY_INSERT Payment OFF;
...
INSERT INTO Subscription (mobileNo, planID, subscription_date, status)
VALUES
('01234567890', 101, '2023-01-01', 'active');


INSERT INTO Subscription (mobileNo, planID, subscription_date, status)
VALUES
('01234567890', 103, '2023-01-01', 'active');

SET IDENTITY_INSERT Payment ON;
INSERT INTO Payment (paymentID, amount, date_of_payment, payment_method, status, mobileNo)
VALUES (9, 5.0, '2023-01-01', 'credit', 'successful', '01234567890')
SET IDENTITY_INSERT Payment OFF;
...
SET IDENTITY_INSERT Payment ON;
INSERT INTO Payment (paymentID, amount, date_of_payment, payment_method, status, mobileNo)
VALUES (10, 15.0, '2023-03-01', 'cash', 'successful', '01122334455')
SET IDENTITY_INSERT Payment OFF;

INSERT INTO Subscription (mobileNo, planID, subscription_date, status)
VALUES
('01122334455', 103, '2023-01-01', 'active');
